    ...
    <div className=" w-10/12 h-fit flex flex-col text-3xl gap-5 m-5">
      ...
      <div className="grid grid-cols-2 w-full h-fit bg-pink-50">
        ...
        <input
          ...
          className="bg-pink-50 w-full h-full p-3 hover:bg-pink-200 overflow-auto border-l-2 border-pink-100"
        ></input>
        <button
          onClick={resetInput}
          className=" row-span-2 col-start-1 col-end-3 bg-pink-100 w-full h-full p-3 hover:bg-pink-200 overflow-auto"
        >
          reset
        </button>
      </div>
